...
//    }
//
//    public List<ProductOrder> search(ProductOrderFilter filter, ProductOrderSort sort) {
...
//    }
//
//    public Integer searchCount(ProductOrderFilter filter) {
//        var query = buildQuery(filter, null);
//        query.addSelect(DSL.count());
//        return query.fetchOneInto(Integer.class);
//    }
//
//    private SelectQuery<Record> buildQuery(ProductOrderFilter filter, ProductOrderSort sort) {
...
//    }
//
//    private SortField[] getOrderFields(ProductOrderSort sort) {
